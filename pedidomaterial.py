...
st.markdown("**Sistema Integrado Google Sheets - Pedido de Material Completo com Imagens e Filtros**")
...
# -------------------- RODAPÉ --------------------
st.markdown("---")
st.markdown("**COGEX ALMOXARIFADO - Integração Google Sheets Completo | Powered by Streamlit**")
